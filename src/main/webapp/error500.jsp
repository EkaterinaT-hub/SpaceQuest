...
<head>
    <meta charset="UTF-8" />
    <title>500 - Server Error | Space Quest</title>
...
<path d='M44 78 C54 90 66 90 76 78' fill='none' stroke='rgb(11,16,32)' stroke-width='6' stroke-linecap='round'/>\
        ...
        /* Links as buttons (same as your page) */
        a{
            display:inline-flex;
            align-items:center;
            justify-content:center;
...
<h2>Oops. The spaceship tripped over its own shoelaces.</h2>

<div class="panel">
    <p>Something went wrong on our side.</p>
    <p>We’re already working on fixing it. (Or at least staring at logs dramatically.)</p>
