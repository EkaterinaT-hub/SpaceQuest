...
<head>
    <meta charset="UTF-8" />
    <title>Space Quest | Result</title>
    ...
    <style>
        ...
        *{ box-sizing:border-box; }
        ...
        h1{
            ...
            position: relative;
            padding-right: 90px; /* space for alien sticker */
        }

        /* alien sticker (same trick) */
        h1::after{
            content:"";
            position:absolute;
            top:-14px;
...
<div class="tag">Mission Report</div>

<hr>

<c:choose>
    <c:when test="${empty sessionScope.result}">
        <h2>No result yet. The universe is buffering…</h2>
        <div class="panel">
            <p>Start a new run and make questionable choices.</p>
            <p>
                <a href="hello">Play again</a>
    ...
    <c:otherwise>
        ...
        <div class="panel">
            <p><b>Tip:</b> If it involved a big red button, it was probably your fault.</p>
            ...
            <h3 style="margin:0 0 10px 0;">Session stats</h3>

            <div class="stats">
                <p><b>Session ID:</b> ${pageContext.session.id}</p>
                <p><b>Created (raw):</b> ${pageContext.session.creationTime}</p>
                <p><b>Player:</b> <c:out value="${sessionScope.playerName}" default="Unknown astronaut"/></p>
                <p><b>Games played:</b> <c:out value="${sessionScope.gamesPlayed}" default="0"/></p>
            </div>

            <p class="tiny">Certified by the Nebula Burger drive-thru clerk ✅</p>
        </div>
    </c:otherwise>
</c:choose>
